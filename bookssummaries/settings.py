...
ROOT_URLCONF = 'bookssummaries.urls'
...
WSGI_APPLICATION = 'bookssummaries.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    ...
    'accounts.authentication.EmailAuthBackend', # <-- to allow email based authentication
]
